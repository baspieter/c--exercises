public static class DialingCodes
{
    ...
    {
        Dictionary<int, string> dialingCodes = DialingCodes.GetEmptyDictionary();
        dialingCodes.Add(44, "United Kingdom");
        return dialingCodes;
    }
    ...
    {
        return existingDictionary.TryGetValue(countryCode, out var value)
            ? value
            : string.Empty;
    }
    ...
    public static Dictionary<int, string> UpdateDictionary(
        Dictionary<int, string> existingDictionary, int countryCode, string countryName)
    {
        if (existingDictionary.ContainsKey(countryCode) == false) return existingDictionary;
    ...
    public static string FindLongestCountryName(Dictionary<int, string> existingDictionary)
    {
        ...
        {
            if (item.Value.Length > longestCountryName.Length) longestCountryName = item.Value;
        }
