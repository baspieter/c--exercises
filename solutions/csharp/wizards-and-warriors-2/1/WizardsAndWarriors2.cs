static class GameMaster
{
    ...
    public static string Describe(TravelMethod travelMethod) => travelMethod == TravelMethod.Walking ? "You're traveling to your destination by walking." : "You're traveling to your destination on horseback.";
